...
plt.plot(x, cdf_smooth1, label='Camera A(SteerCam)', color='blue', linewidth=2)
plt.plot(x, cdf_smooth2, label='Camera B(SteerCam)', color='red', linewidth=2 )
plt.plot(x, cdf_smooth3, label='Camera C(SteerCam)', color='green', linewidth=2)


plt.plot(x, cdf_smooth4, label='Camera A(Static)', linestyle=':', color='blue', linewidth=3)
plt.plot(x, cdf_smooth5, label='Camera B(Static)', linestyle=':', color='red', linewidth=3)
plt.plot(x, cdf_smooth6, label='Camera C(Static)', linestyle=':', color='green', linewidth=3)
